/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 5b4dbf137234e0888cec0c4231f89d33)
// Runtime types generated with workerd@1.20250712.0 2025-03-25 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NODE_ENV: "production";
		DEPLOYMENT_TARGET: "web";
		routes: [{"pattern":"deepict.deepaste.ai","custom_domain":true}];
		ASSETS: Fetcher;
	}
}
